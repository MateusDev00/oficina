...
export type TipoEvento = 'ORDEM_CRIADA' | 'ORDEM_ATRASADA' | 'PAGAMENTO_CONFIRMADO' | 'TECNICO_INDISPONIVEL' | 'ORDEM_CONCLUIDA' | 'AGENDAMENTO_ALTERADO' | 'CLIENTE_NOTIFICADO' | 'REAGENDAMENTO_AUTOMATICO';

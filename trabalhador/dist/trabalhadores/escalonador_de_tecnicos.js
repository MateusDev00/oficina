...
exports.otimizarAlocacoes = otimizarAlocacoes;
const base_de_dados_1 = require("../configuracao/base_de_dados");
async function otimizarAlocacoes() {
    try {
        const ordensResult = await (0, base_de_dados_1.query)(`SELECT id FROM ordens_servico 
       ...
       ORDER BY 
        ...
        const tecnicosResult = await (0, base_de_dados_1.query)(`SELECT u.id, COUNT(o.id) as carga
       FROM utilizadores u
